--STOLEN FROM https://github.com/agalea91/dotfiles/blob/main/nvim/lua/workflows.lua
--------------
-- obsidian --
--------------
--
...
--
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd /home/fate/documents/deez-notes/<cr>")
--
-- convert note to template and remove :Wleading white space
vim.keymap.set("n", "<leader>on", ":ObsidianTemplate default<cr> :lua vim.cmd([[1,/^\\S/s/^\\n\\{1,}//]])<cr>")
-- strip date from note title and replace dashes with spaces
-- must have cursor on title
vim.keymap.set("n", "<leader>of", ":s/\\(# \\)[^_]*_/\\1/ | s/-/ /g<cr>")
--
-- search for files in full vault
vim.keymap.set("n", "<leader>os", ":Telescope find_files search_dirs={\"/home/fate/documents/deez-notes\"}<cr>")
vim.keymap.set("n", "<leader>oz", ":Telescope live_grep search_dirs={\"/home/fate/documents/deez-notes\"}<cr>")
--
...
vim.keymap.set("n", "<leader>ok", ":!mv '%:p' /home/fate/documents/deez-notes/zettelkasten<cr>:bd<cr>")
